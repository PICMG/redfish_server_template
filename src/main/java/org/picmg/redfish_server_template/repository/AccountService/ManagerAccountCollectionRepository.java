...
import org.picmg.redfish_server_template.RFmodels.AllModels.ManagerAccountCollection;
import org.springframework.data.mongodb.repository.MongoRepository;
import org.springframework.data.mongodb.repository.Query;

public interface ManagerAccountCollectionRepository extends MongoRepository<ManagerAccountCollection, Object> {
    @Query(value="{ '_odata_id': ?0 }", fields="{ '_id': 0, '_odata_id': 0}")
    ManagerAccountCollection findFirstByOdataId(String id);
}
